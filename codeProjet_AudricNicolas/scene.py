...
class Scene:
    ...
    def __init__(self,  name:str, width:int=640, height:int=480, clue=None):       
        self.gameboard :GameBoard = GameBoard(KeyPlayer(1),KeyPlayer(2), self)    # initialisation du gameboard
        self.gameboard.scene = self                                         # scene du gameboard
        
        self.widgets :list = []                                             # liste des widgets créés
        ...
        # self.current_scene :Scene = Scene(self, name="menu") # Scène acctuelle et initialisation de la scene. (Commence au menu)
    ...
    def update(self):
        ...
        self.draw()   #dessine les nouveaux éléments
    ...
    def change_scene(self, new_name:str):
        ...
        self.destroy_widgets()    #détruit les widgets du gameboard
        # self.update_current_scene(new_name)         #initialise self.current_scene dans la classe screen
        self.update()                #Dessine la nouvelle scene
    ...
    def menu(self):
        """Stockage des éléments de la scène menu"""
        return [
    ...
    def regles(self):
        """Stockage des éléments de la scène règles"""
        return [
                self.canva.create_rectangle(0, 0, 640, 480, fill="lightblue"),
    ...
    def game1(self):
        """Stockage des éléments des différentes scènes jeu joueur 1"""
        # -- PERTE DU JOUEUR 2 --
    ...
    def key1(self):
        """Stockage des éléments de la scène "clé" du joueur 1"""
        entree_indice = tkint.Entry(self.canva, font=("Arial", 12), width=20)
        self.widgets.append(entree_indice)
        return [
    ...
    def endgame(self):
        return [
                self.canva.create_rectangle((0,0),(640,480), fill="lightblue"),
                self.canva.create_text((320, 240), text=f"Fin de la partie !\nOn s'en refait une ? :)", font=("Arial", 27, "bold"), fill="green", anchor="center"),
            ]
